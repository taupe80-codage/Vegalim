...
| 2 | **Priorité : données vs interface** | Option A : finir 1 000 recettes PUIS interface — Option B : interface en parallèle | Planning et focus des 3 prochains mois | 🔴 Cette semaine |
...
Raison : une belle interface sur un dataset incomplet créera de la frustration
