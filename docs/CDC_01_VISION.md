...
- 812 recettes végétariennes indexées (dont 99 préparations de base)
...
812 recettes ne suffisent pas pour un lancement crédible.
...
La technique backend est solide (102 engines, 101 routes, 812 recettes,
