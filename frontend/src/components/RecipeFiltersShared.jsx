...
export const HEALTH_GROUPS = [
  {
    ...
    subs: [
      { value: 'protein_high',   label: 'Riche en protéines', apiKey: 'high_protein' },
      { value: 'protein_source', label: 'Bonne source',       apiKey: 'good_source_protein' },
    ],
  },
  {
    ...
    subs: [
      { value: 'fiber_high',   label: 'Riche en fibres', apiKey: 'high_fiber' },
      { value: 'fiber_source', label: 'Bonne source',    apiKey: 'good_source_fiber' },
    ],
  },
  {
    ...
    apiKeys: ['low_calorie'],
    subs: [
      { value: 'low_calorie', label: 'Faible en calories', apiKey: 'low_calorie' },
    ],
  },
  {
    value: 'low_ig', label: '🩸 IG Bas',
    apiKeys: ['low_ig', 'moderate_ig'],
    subs: [
      { value: 'low_ig',      label: 'IG bas (< 55)',     apiKey: 'low_ig' },
      { value: 'moderate_ig', label: 'IG modéré (55–70)', apiKey: 'moderate_ig' },
    ],
  },
  {
  ...
  },
  {
    ...
    apiKeys: ['omega3', 'omega3_ala', 'omega3_epa_dha'],
    subs: [
      { value: 'omega3_ala',     label: 'ALA (végétal)', apiKey: 'omega3_ala' },
      { value: 'omega3_epa_dha', label: 'EPA/DHA',       apiKey: 'omega3_epa_dha' },
    ],
  },
  {
    value: 'vitamins', label: '🍊 Vitamines',
    apiKeys: ['high_vitamin_c', 'source_vitamin_c', 'high_vitamin_d', 'high_folate'],
    subs: [
      { value: 'vitamin_c', label: 'Vitamine C', apiKey: 'high_vitamin_c' },
      { value: 'vitamin_d', label: 'Vitamine D', apiKey: 'high_vitamin_d' },
      { value: 'folate',    label: 'Folate',     apiKey: 'high_folate' },
    ],
  },
  {
  ...
  },
  {
    ...
    apiKeys: ['antioxidant_rich', 'high_polyphenol', 'high_beta_carotene'],
    subs: [
      { value: 'antioxidant_rich',   label: 'Riche en antioxydants', apiKey: 'antioxidant_rich' },
      { value: 'high_polyphenol',    label: 'Polyphénols',           apiKey: 'high_polyphenol' },
      { value: 'high_beta_carotene', label: 'Bêta-carotène',         apiKey: 'high_beta_carotene' },
    ],
  },
];
...
const _LOCAL_SUB_MAP = {
  ...
  low_ig:              r => r.health_scores?.low_ig,
  moderate_ig:         r => r.health_scores?.low_ig,
  omega3_ala:          r => r.health_scores?.source_omega3 || r.health_scores?.omega3_ala,
  omega3_epa_dha:      r => r.health_scores?.high_omega3   || r.health_scores?.omega3_epa_dha,
  vitamin_c:           r => r.health_scores?.high_vitamin_c || r.health_scores?.source_vitamin_c,
  vitamin_d:           r => r.health_scores?.high_vitamin_d,
  folate:              r => r.health_scores?.high_folate,
  ...
  high_polyphenol:     r => r.health_scores?.antioxidant_rich,
  high_beta_carotene:  r => r.health_scores?.antioxidant_rich,
};
...
const _LOCAL_GROUP_MAP = {
  ...
  energie:      r => r.health_scores?.low_calorie,
  low_ig:       r => r.health_scores?.low_ig,
  low_fodmap:   r => r.health_scores?.low_fodmap || r.health_scores?.fodmap === 'low',
  omega3:       r => r.health_scores?.source_omega3 || r.health_scores?.high_omega3,
  vitamins:     r => r.health_scores?.high_vitamin_c || r.health_scores?.high_vitamin_d || r.health_scores?.high_folate,
