...
export const CUISINE_LABEL_FR = {
  ...
  // France (régions)
  french_auvergnat:    "Auvergnate",
  french_basque:       'Basque',
  french_bordelaise:   'Bordelaise',
  french_breton:       'Bretonne',
  french_burgundian:   'Bourguignonne',
  french_creative:     'Cuisine créative',
  french_fusion:       'Fusion française',
  french_gascon:       'Gasconne',
  french_limousin:     'Limousine',
  french_lyonnaise:    'Lyonnaise',
  french_mediterranean:'Méditerranéenne (FR)',
  french_nordic:       'Franco-nordique',
  french_normand:      'Normande',
  french_southern:     'Sud de France',
  french_vendeen:      'Vendéenne',
  // Amériques
  andean:           'Andine',
